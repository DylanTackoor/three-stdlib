...
class GeometryParser {
  ...
  genBuffers = (geoInfo) => {
    ...
    geoInfo.vertexIndices.forEach((vertexIndex, polygonVertexIndex) => {
      ...
      if (geoInfo.material && geoInfo.material.mappingType !== 'AllSame') {
        // getData comes from FBXTree
        const materialIndex = getData(polygonVertexIndex, polygonIndex, vertexIndex, geoInfo.material)[0]
      }
...
class AnimationParser {
   ...
   * to constious AnimationCurveNodes and is referenced by an AnimationStack node
            ...
            if (
              ...
              if (layerCurveNodes[i] === undefined) {
                const modelID = connections
                  .get(child.ID)
                  .parents.filter((parent) => parent.relationship !== undefined)[0].ID
  ...
  generateTracks = (rawTracks) => {
    ...
    // TODO: declare new variables here (or the ones just above)
...
class TextParser {
  getPrevNode = () => this.nodeStack[this.currentIndent - 2]

  getCurrentNode = () => this.nodeStack[this.currentIndent - 1]
 ...
 * TODO: confirm if is a Date | number
 * @param time
 * @returns
 */
 ...
 * @link https://help.autodesk.com/view/FBX/2017/ENU/?guid=__files_GUID_10CDD63C_79C1_4F2D_BB28_AD2BE65A02ED_htm
 * @link http://docs.autodesk.com/FBX/2014/ENU/FBX-SDK-Documentation/index.html?url=cpp_ref/_transformations_2main_8cxx-example.html,topicNumber=cpp_ref__transformations_2main_8cxx_example_htmlfc10a1e1-b18d-4e72-9dc0-70d0f1959f5e
 * @param transformData
 * @returns
 */
function generateTransform(transformData): Matrix4 {
